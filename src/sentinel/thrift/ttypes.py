...
class MachineStatus:
  ...
  thrift_spec = (
    ...
    (6, TType.LIST, 'loadavgs', (TType.DOUBLE,None), None, ), # 6
    (7, TType.I16, 'cpu_total', None, None, ), # 7
    (8, TType.LIST, 'cpu_usages', (TType.I16,None), None, ), # 8
    (9, TType.I64, 'memory_total', None, None, ), # 9
    (10, TType.I64, 'memory_free', None, None, ), # 10
    (11, TType.I64, 'swap_total', None, None, ), # 11
    (12, TType.I64, 'swap_free', None, None, ), # 12
    (13, TType.LIST, 'processes', (TType.STRUCT,(ProcessInfo, ProcessInfo.thrift_spec)), None, ), # 13
  ...
  def __init__(self, timestamp=None, os_type=None, os_version=None, uptime=None, idletime=None, loadavgs=None, cpu_total=None, cpu_usages=None, memory_total=None, memory_free=None, swap_total=None, swap_free=None, processes=None, netdevs=None, blockdevs=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i10 in xrange(_size6):
            ...
            self.cpu_usages.append(_elem11)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        ...
        if ftype == TType.LIST:
          ...
          for _i22 in xrange(_size18):
            _elem23 = NetworkDeviceInfo()
            _elem23.read(iprot)
            self.netdevs.append(_elem23)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.LIST:
          ...
          for _i28 in xrange(_size24):
            _elem29 = BlockDeviceInfo()
            _elem29.read(iprot)
            self.blockdevs.append(_elem29)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.idletime is not None:
      ...
      oprot.writeFieldEnd()
    if self.loadavgs is not None:
      oprot.writeFieldBegin('loadavgs', TType.LIST, 6)
      oprot.writeListBegin(TType.DOUBLE, len(self.loadavgs))
      for iter30 in self.loadavgs:
        oprot.writeDouble(iter30)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.cpu_total is not None:
      oprot.writeFieldBegin('cpu_total', TType.I16, 7)
      oprot.writeI16(self.cpu_total)
      oprot.writeFieldEnd()
    if self.cpu_usages is not None:
      oprot.writeFieldBegin('cpu_usages', TType.LIST, 8)
      oprot.writeListBegin(TType.I16, len(self.cpu_usages))
      for iter31 in self.cpu_usages:
        oprot.writeI16(iter31)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.memory_total is not None:
      oprot.writeFieldBegin('memory_total', TType.I64, 9)
      oprot.writeI64(self.memory_total)
      oprot.writeFieldEnd()
    if self.memory_free is not None:
      oprot.writeFieldBegin('memory_free', TType.I64, 10)
      oprot.writeI64(self.memory_free)
      oprot.writeFieldEnd()
    if self.swap_total is not None:
      oprot.writeFieldBegin('swap_total', TType.I64, 11)
      oprot.writeI64(self.swap_total)
      oprot.writeFieldEnd()
    if self.swap_free is not None:
      oprot.writeFieldBegin('swap_free', TType.I64, 12)
      oprot.writeI64(self.swap_free)
      oprot.writeFieldEnd()
    if self.processes is not None:
      oprot.writeFieldBegin('processes', TType.LIST, 13)
      oprot.writeListBegin(TType.STRUCT, len(self.processes))
      for iter32 in self.processes:
        iter32.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
